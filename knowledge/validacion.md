...
Ambos corren localmente y en CI (`.github/workflows/validate.yml`, que además valida los nodos OKF y corre la suite). **Ningún contrato se considera terminado hasta que pase el nivel 1.**
